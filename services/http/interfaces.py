...
from EP4UServices.services.core import LLMChatInterface, LLMVisionInterface, ParseInterface, TTSEngineInterface
...
class RemoteVisionServiceBase(RemoteService, LLMVisionInterface):
    def __init__(self, url, endpoint, model):
        super().__init__(url, endpoint)
        self.model = model
